...
5. Write the output to `~/Timesheets/<today-date>.md` using the Write tool, where `<today-date>` is today's date in `yyyy-mm-dd` format.
6. Open the file with `notepad ~/Timesheets/<today-date>.md`.
